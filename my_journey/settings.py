"""
Django settings for my_journey project.
...
SECRET_KEY = 'django-insecure-!uq#tbd(r@(zeo%#a)(4@n6qg%u%a7h80524+3gdk@s88sxs!z'
...
WSGI_APPLICATION = 'my_journey.wsgi.application'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'my-journey@example.com'
else:
